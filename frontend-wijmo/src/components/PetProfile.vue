            ...
            <v-row cols="12">
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">PetType</div>
                        <String label="입력하세요." v-model="value.petType" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
                ...
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">Needs</div>
                        <String label="입력하세요." v-model="value.needs" :editMode="editMode"/>
                    </div>
                </v-col>
            </v-row>
        </div>
...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/petProfiles";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "petProfiles."+ me.value.id +".get"
