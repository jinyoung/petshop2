            ...
            <v-row cols="12">
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">ReviewId</div>
                        <String label="입력하세요." v-model="value.reviewId" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
                ...
                <v-col cols="6">
                    <div style="display:flex;">
                        ...
                        <String label="입력하세요." v-model="value.comment" :editMode="editMode"/>
                    </div>
                </v-col>
            </v-row>
        </div>
...
import ProductReviewBase from '../components/ProductReviewBase.vue'
...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/productReviews";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "productReviews."+ me.value.reviewId +".get"
