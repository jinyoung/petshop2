            ...
            <v-row cols="12">
                ...
                <v-col cols="6">
                    <div style="display:flex;">
                        ...
                        <String label="입력하세요." v-model="value.productName" :editMode="editMode"/>
                    </div>
                </v-col>
            </v-row>
        </div>
...
import PurchasedProductBase from '../components/PurchasedProductBase.vue'
...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/purchasedProducts";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "purchasedProducts."+ me.value.productId +".get"
    ...
    methods: {
        ...
        async save(){
            try {
                ...
                if(!this.offline) {
                    if(this.isNew) {
                        temp = await axios.post(axios.fixUrl('/purchasedProducts'), this.value)
                    } else {
