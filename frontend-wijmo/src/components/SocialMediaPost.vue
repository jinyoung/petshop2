            ...
            <v-row cols="12">
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">PostId</div>
                        <String label="입력하세요." v-model="value.postId" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
                ...
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">ImageUrl</div>
                        <String label="입력하세요." v-model="value.imageUrl" :editMode="editMode"/>
                    </div>
                </v-col>
            </v-row>
        </div>
...
import SocialMediaPostBase from '../components/SocialMediaPostBase.vue'
...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/socialMediaPosts";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "socialMediaPosts."+ me.value.postId +".get"
    ...
    methods: {
        ...
        async save(){
            try {
                ...
                if(!this.offline) {
                    if(this.isNew) {
                        temp = await axios.post(axios.fixUrl('/socialMediaPosts'), this.value)
                    } else {
