<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['petType','age','size','gender','preferences','needs','allegies',]" />
        ...
        <AllegiesDetailGrid :selectedGrid="selectedGrid" />
        <v-col>
            <v-dialog
                v-model="openDialog"
            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">PetProfile 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
...
import AllegiesDetailGrid from './AllegiesDetailGrid.vue'
...
export default {
    ...
    methods:{
        ...
        onSelectionChanged(s) {
            ...
            if (selectedItem) {
                this.selectedGrid = selectedItem.allegies;
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.petProfile.href;
