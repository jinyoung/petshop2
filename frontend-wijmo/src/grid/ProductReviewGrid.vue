<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['reviewId','productId','rating','comment',]" />
            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">ProductReview 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
...
export default {
    name : 'productReview-grid',
    mixins:[ProductReview],
    components:{
        ProductReview,
    },
    data: () => ({
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.productReview.href;
