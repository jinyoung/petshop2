<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['productId','productName','price',]" />
            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">PurchasedProduct 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
...
<script>
import PurchasedProduct from '../components/PurchasedProduct.vue'
...
export default {
    name : 'purchasedProduct-grid',
    mixins:[PurchasedProduct],
    components:{
        PurchasedProduct,
    },
    data: () => ({
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.purchasedProduct.href;
